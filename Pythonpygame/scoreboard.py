...
class Scoreboard:
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            ship.rect.width = 50
            ship.rect.height = 50
            ship.image = pygame.transform.scale(ship.image, (ship.rect.width, ship.rect.height))
...
class GameOver:
    ...
    def prep_game_over(self):
        self.game_over_image = self.font.render("Game Over", True, self.text_color, self.settings.bg_color)
